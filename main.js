...
let pages = [
    homePage = new Page([
        ...
        new TextBox(new Vec2d(50, 80).screenPercent(), 'text-container', 'text', 80, '(If an issue occurs, reload the website or try resizing the website and then reloading it, I apologize in advance for any potential inconveniences as a result of programming :D )').center()
    ]),
    alwynMorrisPage = new Page([
        ...
        new TextBox(new Vec2d(10, 160).screenPercent(), 'text-container', 'text', 80, 'Sources:\n\nTeam Canada - Canadian Olympic Committee. (2019, September 20). Alwyn Morris - Team Canada. Team Canada. https://olympic.ca/team-canada/alwyn-morris/\n\nCbc. (2009, December 9). Olympic torch cheered in Mohawk community. CBC. https://www.cbc.ca/news/canada/montreal/olympic-torch-cheered-in-mohawk-community-1.776911\n\nWikipedia contributors. (2025b, December 29). Alwyn Morris. Wikipedia. http://en.wikipedia.org/wiki/Alwyn_Morris\n\nDirk Meissner The Canadian Press. "From a Single Feather to a Top-flight Program." Toronto Star, 27 Dec. 2009, www.thestar.com/sports/olympics-and-paralympics/from-a-single-feather-to-a-top-flight-program/article_732072d7-9c78-51ee-9818-7cccd1a2232a.html. '),
        new ImageHTMLElement('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOMbyoBHZ71JnhAqCdljrc_YAURKggtdB3XaYRZwlnHdq-aChrvEjXJBqVjkW6-uMhMPpIcr-Gcz6ooBi96pl-FxWfVm2Vt4qptDPcQg&s=10', new Vec2d(60, 20).screenPercent(), 'image-container', 'image'),
        new ImageHTMLElement('https://olympic.ca/wp-content/uploads/2011/09/142116510-e1546624419400.jpg?quality=100', new Vec2d(10, 80).screenPercent(), 'image-container', 'image').resize(300)
    ]),
    ...
    riceWaubgeshigPage = new Page([
        ...
        new TextBox(new Vec2d(10, 110).screenPercent(), 'text-container', 'text', 80, 'Sources:\nWikipedia contributors. (2026, January 4). Waubgeshig Rice. Wikipedia. https://en.wikipedia.org/wiki/Waubgeshig_Rice\n\nMy WordPress. (2025, September 26). About - Waubgeshig Rice Author journalist. Waubgeshig Rice Author Journalist - Representing Wasauksing First Nation. https://waub.ca/about/\n\nWaubgeshig Rice | The Writers\' Union of Canada. (n.d.-b). https://writersunion.ca/member/waubgeshig-rice \n\nWikipedia contributors. (2025, October 14). Moon of the crusted snow. Wikipedia. https://en.wikipedia.org/wiki/Moon_of_the_Crusted_Snow'),
        new ImageHTMLElement('https://images.squarespace-cdn.com/content/v1/63c85cd787bfcf46d3a5fcb2/dae1747b-1d38-4b69-a2a0-ad626075dfcf/au-Rice-credit-Shilo-Adamson.jpg', new Vec2d(60, 20).screenPercent(), 'image-container', 'image'),
        new ImageHTMLElement('https://m.media-amazon.com/images/I/71Saa3PUKYL._UF1000,1000_QL80_.jpg', new Vec2d(63, 80).screenPercent(), 'image-container', 'image').resize(300),
        new ImageHTMLElement('https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1410298891i/23196841.jpg', new Vec2d(80, 80).screenPercent(), 'image-container', 'image').resize(300)
    ])
];
